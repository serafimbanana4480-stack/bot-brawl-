...
class StateContext:
    ...
    neural_policy: object | None = None  # Neural policy for decision making
    current_image: object | None = None  # Current frame image
    aux_state: object | None = None  # Auxiliary state [health, ammo]
...
class StateMachine:
    ...
    def get_neural_decision(self, context: StateContext) -> dict | None:
        """
